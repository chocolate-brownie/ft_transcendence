...
/**
 * Top navigation bar that displays the brand, navigation links, and user controls.
 *
 * For authenticated users it renders navigation links and an avatar dropdown with profile, leaderboard, and logout actions.
 * For unauthenticated users it shows a health status pill and links to sign in or sign up. The component also closes the dropdown on outside clicks and checks system health for guests.
 *
 * @returns The Navbar component's JSX element containing the app's top navigation UI.
 */
