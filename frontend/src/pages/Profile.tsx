...
/**
 * Renders the user profile page and manages profile viewing, editing, avatar uploads, and friendship interactions.
 *
 * This component resolves the target profile from the route params or the authenticated user, redirects
 * to /profile or /login when appropriate, and fetches the target user's profile, current user's friends,
 * and incoming pending friend requests. When viewing your own profile it provides editing of display name,
 * avatar upload, and a list of friends and pending requests. When viewing another user's profile it shows
 * friendship actions (Add Friend, Accept/Decline, Remove Friend) and reflects online status, stats, and
 * basic profile information. Loading and error states are handled for each fetch, and UI lists are kept
 * in sync with friendship actions.
 *
 * @returns The rendered profile page as a JSX element.
 */
